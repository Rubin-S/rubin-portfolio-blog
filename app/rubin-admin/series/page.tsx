                            ...
                            {series.length === 0 ? (
                                ...
                                series.map((s) => (
                                    <tr key={s.id} className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                                        <td className="p-4 align-middle font-medium">{s.title}</td>
                                        <td className="p-4 align-middle">{s.slug}</td>
                                        <td className="p-4 align-middle truncate max-w-xs">{s.description}</td>
                                        <td className="p-4 align-middle text-right">
                                            <Link href={`/rubin-admin/series/${s.slug}/edit`} className="text-primary hover:underline">
                                                Edit
                                            </Link>
                                        </td>
                                    </tr>
