...
import TypographySwitchWrapper from "@/components/TypographySwitchWrapper";
    ...
    >
      <div className="mx-auto max-w-6xl px-4 flex justify-between items-center">
        ...
        <nav className="flex items-center gap-6 text-sm font-serif">
          <Link href="/blog" className="hover:underline underline-offset-4 decoration-1 transition-all">Journal</Link>
          <Link href="/projects" className="hover:underline underline-offset-4 decoration-1 transition-all">Projects</Link>
          <Link href="/about" className="hover:underline underline-offset-4 decoration-1 transition-all">About</Link>
