...
// We extend Post slightly to ensure we handle the UI needs
export interface AdminPostRow extends Post {
  // We already sanitized 'metrics' in the parent page
}

export default function PostTable({ initialPosts }: { initialPosts: AdminPostRow[] }) {
